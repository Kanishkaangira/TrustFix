-- TrustFix existing-db update to fully separate customer and technician profile tables.
-- Run this after trustfix_core_schema.sql and trustfix_technician_schema.sql.
--
-- Result:
-- - public.profiles stays customer-only
-- - public.technician_profiles links directly to auth.users
-- - deleting a customer profile row will no longer delete technician_profiles rows
