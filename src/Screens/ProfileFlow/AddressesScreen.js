// src/Screens/ProfileFlow/AddressesScreen.js
...
const AddBtn = () => (
  <TouchableOpacity activeOpacity={0.7}>
    <Text style={{ color: PC.brand, fontWeight: '700', fontSize: 14 }}>+ Add</Text>
  </TouchableOpacity>
);

export default function AddressesScreen({ onBack }) {
  return (
    <SubScreenShell title="Saved Addresses" onBack={onBack} rightAction={<AddBtn />}>
      <ScrollView
