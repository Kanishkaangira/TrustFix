...
const STATS = [
  ...
  { num: '50K+', label: 'Jobs Served' },
  { num: '28', label: 'Cities' },
];

const VALUES = [
  { label: 'Fair Leads', desc: 'Transparent job routing for technicians' },
  { label: 'Fast Payouts', desc: 'Clear earnings and quick settlements' },
  { label: 'Verified Trust', desc: 'Professional identity and safer jobs' },
  { label: 'Growth Tools', desc: 'Plans built for serious partner growth' },
];
        ...
        >
          <View style={styles.hero}>
            <Text style={styles.logoText}>
              Trust<Text style={styles.logoTextAccent}>Fix Pro</Text>
            </Text>
            <Text style={styles.tagline}>Built for trusted service professionals.</Text>
          ...
          <View style={styles.missionCard}>
            ...
            <Text style={styles.missionText}>
              TrustFix Pro helps skilled technicians grow with better job visibility,
              transparent plan benefits, and a cleaner day-to-day work experience.
            </Text>
          </View>
          ...
          <Text style={styles.footer}>
            TrustFix Pro | Copyright 2026 TrustFix Pvt. Ltd.
          </Text>
        </ScrollView>
      </SubScreenShell>
    </ScreenWrapper>
