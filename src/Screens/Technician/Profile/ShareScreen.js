      ...
      >
        ...
        >
          <View style={styles.hero}>
            ...
            <Text style={styles.heroTitle}>Invite Technicians and Earn</Text>
            <Text style={styles.heroSub}>
              Share TrustFix Pro with other skilled professionals and unlock
          ...
          <View style={styles.refCard}>
            ...
            <View style={styles.refRow}>
              <View style={styles.refCodeBox}>
                <Text style={styles.refCode}>RAMESHPRO</Text>
              </View>
            ...
            <View style={styles.rewardRow}>
              ...
              <Text style={styles.rewardText}>
                You have earned INR 1200 from 4 partner referrals so far.
              </Text>
            </View>
          </View>
          ...
          <View style={styles.linkCard}>
            <Text style={styles.linkText} numberOfLines={1}>
              https://trustfix.in/pro/ref/RAMESHPRO
            </Text>
