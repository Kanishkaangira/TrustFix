...
const PLANS = [
  {
    id: 'basic',
    name: 'Basic',
    sub: 'For part-time technicians',
    price: 'INR 299',
    priceSub: '/mo',
    features: ['30 job leads per month', 'Verified partner badge'],
    missing: ['Emergency jobs access', 'Priority queue'],
    current: false,
  },
  {
    id: 'pro',
    name: 'Pro Plan',
    sub: 'Best for daily working technicians',
    price: 'INR 599',
    priceSub: '/mo',
    features: [
      'Unlimited job leads',
  ...
  },
  {
    id: 'elite',
    name: 'Elite',
    sub: 'Maximum visibility and priority',
    price: 'INR 999',
    priceSub: '/mo',
    strikePrice: 'INR 1199',
    features: [
      'First pick on all matching jobs',
      'Featured profile placement',
      'Emergency jobs first priority',
      ...
      >
        ...
        >
          <View style={styles.currentCard}>
            ...
            <Text style={styles.currentName}>Pro Plan</Text>
            <Text style={styles.currentExp}>
              Renews May 1, 2026 | Auto-renew ON
            </Text>
            <Text style={styles.currentPrice}>
              INR 599 <Text style={styles.currentPriceSub}>/ month</Text>
            </Text>
            <View style={styles.perksRow}>
              {['Unlimited leads', 'Priority queue', 'Emergency access'].map(perk => (
