...
const OPTIONS = [
  {
    ...
    title: 'Light',
    subtitle: 'Bright surfaces and sharper contrast for daytime technician workflows.',
    chip: 'Day Shift',
  },
  {
    id: THEME_MODES.DARK,
    title: 'Dark',
    subtitle: 'Low-glare surfaces and calmer contrast for longer work sessions.',
    chip: 'Night Shift',
  },
];
    ...
    >
      ...
      >
        ...
        >
          ...
          <Text style={styles.pageTitle}>Choose how TrustFix Pro looks</Text>
          <Text style={styles.pageSubtitle}>
            Switch instantly between bright and low-glare layouts anytime from your technician profile.
          </Text>
                  ...
                  <View style={styles.optionBody}>
                    ...
                    <View style={styles.optionMeta}>
                      ...
                      <Text style={[styles.optionMetaText, isDarkOption && styles.optionMetaTextDark]}>
                        {isDarkOption
                          ? 'Best for evening calls and lower eye strain.'
                          : 'Best for daylight visits and clearer readability.'}
                      </Text>
                    </View>
